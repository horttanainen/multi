...
fn shimeBodyConfig(base_freq: f32, stroke: TaikoStroke, volume: f32) ModalDrumBodyConfig(SHIME_MODE_COUNT) {
    return switch (stroke) {
        .don => .{
            ...
            .mode_t60s = .{ 0.030, 0.045, 0.075, 0.105, 0.130, 0.110, 0.085, 0.060, 0.040, 0.028, 0.020 },
            .mode_gains = .{ 0.040, 0.12, 0.48, 0.68, 0.52, 0.38, 0.25, 0.15, 0.080, 0.040, 0.018 },
            .body_lpf_hz = 5600.0,
            .body_hpf_hz = base_freq * 0.92,
            .noise_lpf_hz = 5200.0,
            .noise_lpf2_hz = 6200.0,
            .noise_hpf_hz = 1250.0,
            .body_mix = 0.68,
            .noise_mix = 0.48,
            .strike_attack_s = 0.001,
            .strike_decay_s = 0.018,
            .strike_release_s = 0.004,
            .strike_noise_samples = 820,
            .strike_noise_decay = 0.040,
            .strike_cluster_count = 2,
            .strike_cluster_spacing = 42,
            .strike_cluster_rolloff = 0.42,
            .velocity_floor = 0.52,
        ...
        .ka => .{
            ...
            .mode_t60s = .{ 0.018, 0.024, 0.032, 0.038, 0.034, 0.026, 0.020, 0.016, 0.012, 0.010, 0.008 },
            .mode_gains = .{ 0.060, 0.12, 0.24, 0.42, 0.60, 0.48, 0.35, 0.22, 0.13, 0.070, 0.030 },
            .body_lpf_hz = 6200.0,
            .body_hpf_hz = base_freq * 2.20,
            .noise_lpf_hz = 6800.0,
            .noise_lpf2_hz = 7600.0,
            .noise_hpf_hz = 2100.0,
            .body_mix = 0.16,
            .noise_mix = 1.35,
            .strike_attack_s = 0.001,
            .strike_decay_s = 0.008,
            .strike_release_s = 0.003,
            .strike_noise_samples = 360,
            .strike_noise_decay = 0.070,
            .strike_cluster_count = 2,
            .strike_cluster_spacing = 24,
            .strike_cluster_rolloff = 0.34,
            .velocity_floor = 0.54,
        ...
        .ghost => .{
            ...
            .mode_t60s = .{ 0.020, 0.026, 0.034, 0.038, 0.034, 0.027, 0.021, 0.016, 0.012, 0.009, 0.007 },
            .mode_gains = .{ 0.025, 0.080, 0.20, 0.25, 0.20, 0.14, 0.090, 0.052, 0.028, 0.014, 0.006 },
            .body_lpf_hz = 3900.0,
            .body_hpf_hz = base_freq * 0.98,
            .noise_lpf_hz = 3000.0,
            .noise_lpf2_hz = 3800.0,
            .noise_hpf_hz = 950.0,
            .body_mix = 0.34,
            .noise_mix = 0.42,
            .strike_attack_s = 0.001,
            .strike_decay_s = 0.007,
            .strike_release_s = 0.003,
            .strike_noise_samples = 300,
            .strike_noise_decay = 0.065,
            .strike_cluster_count = 1,
            .strike_cluster_spacing = 0,
            .strike_cluster_rolloff = 0.40,
            .velocity_floor = 0.46,
            .velocity_sensitivity = 0.42,
            .volume = volume * 1.55,
        },
