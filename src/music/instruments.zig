...
fn shimeBodyConfig(base_freq: f32, stroke: TaikoStroke, volume: f32) ModalDrumBodyConfig(SHIME_MODE_COUNT) {
    return switch (stroke) {
        ...
        .ka => .{
            ...
            .mode_t60s = .{ 0.045, 0.058, 0.070, 0.064, 0.052, 0.040, 0.030, 0.023, 0.017, 0.012, 0.009 },
            .mode_gains = .{ 0.18, 0.34, 0.52, 0.62, 0.52, 0.38, 0.26, 0.16, 0.090, 0.048, 0.020 },
            .body_lpf_hz = 5400.0,
            .body_hpf_hz = base_freq * 1.18,
            .noise_lpf_hz = 5600.0,
            .noise_lpf2_hz = 6600.0,
            .noise_hpf_hz = 1500.0,
            .body_mix = 0.38,
            .noise_mix = 0.95,
            .strike_attack_s = 0.001,
            ...
            .strike_noise_decay = 0.052,
            .strike_cluster_count = 2,
            .strike_cluster_spacing = 36,
            .strike_cluster_rolloff = 0.42,
            .velocity_floor = 0.54,
