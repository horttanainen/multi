...
fn initExplosions() !void {
    ...
    const Entry = struct {
        ...
        particleColor: sprite.Color = .{ .r = 255, .g = 255, .b = 255 },
    ...
    for (parsed.value) |entry| {
        ...
        explosionDataMap.put(allocator, key, .{
            ...
            .particleLifetimeMs = entry.particleLifetimeMs,
...
pub fn createExplosionFrom(key: []const u8) !projectile.Explosion {
    ...
    return projectile.Explosion{
        ...
        .particleSpeed = d.particleSpeed,
        .particleRadius = d.particleRadius,
        .particleLifetimeMs = d.particleLifetimeMs,
