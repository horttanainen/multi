...
pub const MASK_TERRAIN = CATEGORY_TERRAIN | CATEGORY_PLAYER | CATEGORY_PROJECTILE | CATEGORY_PARTICLE | CATEGORY_DYNAMIC | CATEGORY_GIBLET | CATEGORY_SENSOR | CATEGORY_UNBREAKABLE | CATEGORY_HOOK;
pub const MASK_UNBREAKABLE = MASK_TERRAIN;

pub const MASK_PLAYER = CATEGORY_TERRAIN | CATEGORY_DYNAMIC | CATEGORY_GIBLET | CATEGORY_PROJECTILE | CATEGORY_PARTICLE | CATEGORY_SENSOR | CATEGORY_UNBREAKABLE | CATEGORY_HOOK;
...
pub const MASK_DYNAMIC = CATEGORY_TERRAIN | CATEGORY_PLAYER | CATEGORY_PROJECTILE | CATEGORY_PARTICLE | CATEGORY_DYNAMIC | CATEGORY_GIBLET | CATEGORY_SENSOR | CATEGORY_UNBREAKABLE | CATEGORY_HOOK;
...
pub const MASK_EXPLOSION_IMPULSE = CATEGORY_DYNAMIC | CATEGORY_GIBLET;
