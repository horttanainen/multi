...
pub const config: Config = .{ .window = .{ .width = 800, .height = 800 }, .met2pix = 80, .player = .{ .materialId = 666, .restingFriction = 100, .movementFriction = 0.1, .sidewaysMovementForce = 5, .jumpImpulse = 1, .maxAirJumps = 1, .maxMovementSpeed = 6 } };
